		...
		<div id="main" class="container">
			<div class="form-wrapper-container">
				<div class="form-wrapper">
					...
					<form id="sendform"
						action="<%=request.getContextPath()%>/addressChangeConfirm" method="post">
						<%
						...
						<div class="form-row">
							...
							<div class="form-input-date">
								<input type="date" id="addressChangedDate" name="addressChangedDate"
						...
						<div class="h-adr">
							...
							<div class="form-row">
								...
								<div class="form-input">
									<input type="text" id="neareststation" name="neareststation"placeholder="例：JR大阪駅" />
								</div>
							</div>
							<div class="form-link">
