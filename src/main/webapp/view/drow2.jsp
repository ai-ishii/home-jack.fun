...
<body>
	...
	<!-- 詳細から一覧へ戻るボタン -->
	<a class="listButton" href="<%=request.getContextPath()%>/一覧"> <svg
			class="memo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
	...
	<button class="confirmButton">
		<svg class="memo" xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 48 48" width="48px" height="48px">
										...
										<polyline class="path"
				points="17.5 23.48 22.5 28.48 30.5 20.48" fill="none" stroke="#fff"
