...
public class JackWorksDAO {
	...
	public void insert(Jackworks jack) {
		...
		try {
			...
			String sql = "INSERT INTO jackworks_info VALUES (NULL, NULL, '"+jack.getName()+"', '"+jack.getEmployeeNumber()+"', '"+jack.getCategory()+"', "
					+ "'"+jack.getAssessment()+"', '"+jack.getPoint()+"', '"+ nowDate +"', '"+jack.getNote()+"',"
					+ " '"+jack.getProject()+"', '"+jack.getWorkSeason()+"', '"+jack.getPrice()+"', '"+jack.getPay()+"', '"+jack.getWorkPlace()+"', "
					+ "'"+jack.getWorkContent()+"', '"+jack.getPhase()+"', '"+jack.getLanguage()+"', '"+jack.getSkill()+"', '"+jack.getNeedPeople()+"', "
					+ "'"+jack.getSeller()+"', '"+jack.getContact()+"', '"+jack.getOther()+"', '"+jack.getManagerFlag()+"', '"+jack.getAdminFlag()+"')";
